...
const patterns: PatternProps[] = [
  ...
  },
  {
    ...
    types: ["Blocking — ошибка, нельзя продолжить", "Warning — требуется внимание", "Info — контекст", "AI — действие агента"],
    behavior: ["сигнал всегда привязан к контексту (объекту или действию)", "не блокирует действия пользователя", "сигнал не должен ломать поток пользователя"],
  },
  {
    id: "ASYNC_STATE",
    name: "Async State",
